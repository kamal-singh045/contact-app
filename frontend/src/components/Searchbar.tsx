...
const Searchbar = () => {
	...
	return (
		<div className="flex-1">
			<input ref={currentValue} onChange={debouncedSearchHandler} type="search" placeholder="Search here..." className="rounded-full w-[50%] px-3 py-2 border border-black focus:outline-none" />
		</div>
	)
}
